...
const Navbar = () => {
  return (
    <>
    <div className="bg-[#18a895] bg-cover h-100vh w-100vw ">
      ...
      <div id="About" className="flex flex-row mt-4">
       <div>
        <h1 className="text-white text-4xl text-underline ml-4">About Me:</h1>
        <p className="text-xl ml-20">I Am Sk.Mehathaf Ali.A Computer Science and Engineering (CSE) B.Tech. student from Bharath Institute of Higher
      ...
      <div id="Expreience">
        <h1 className="text-white text-4xl text-underline ml-4 ">Expreience:</h1>
          <div>
           <h1 className="text-black text-2xl ml-7">Ural Federal University</h1>
          <div className="ml-15 text-xl">
          ...
          <div>
           <h1 className="text-black text-2xl ml-7">Motion Cut</h1>
          <div className="ml-15 text-xl">
          ...
          <div>
           <h1 className="text-black text-2xl ml-7 ">NXT Wave</h1>
          <div className="ml-15 text-xl">
        ...
        <h1 className="text-white text-4xl text-underline ml-4 mt-5">Skills:</h1>
         <div className="flex flex-row align-center">
          <div className="bg-[#f5f5f5] h-50 w-50 flex flex-col  rounded-2xl shadow-xl ml-30">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR1z0LC70CF3lPE1Xe-Uka4Y5sSlLzrAVHCQg&s" className="rounded-2xl w-40 h-30 ml-3 mt-3" />
            <h1 className="text-center text-3xl mt-5">Python</h1>
          </div>
          <div className="bg-[#f5f5f5] h-50 w-50 flex flex-col  rounded-2xl shadow-xl ml-30">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSj5K08rKxUEHZsgxTHElnQc6bFEmuVzD6FUg&s" className="rounded-2xl w-40 h-30 ml-3 mt-3" />
            <h1 className="text-center text-3xl mt-5">Html</h1>
          </div>
          <div className="bg-[#f5f5f5] h-50 w-50 flex flex-col  rounded-2xl shadow-xl ml-30">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ5knOAB5VVnulJ0efWUFhtSNj2KjM5PTGINk3k5R2iHZsJgjoUcv2FAfWJpAUh1B_wsg8&usqp=CAU" className="rounded-2xl w-40 h-30 ml-3 mt-3" />
            <h1 className="text-center text-3xl mt-5">CSS</h1>
          </div>
          <div className="bg-[#f5f5f5] h-50 w-50 flex flex-col  rounded-2xl shadow-xl ml-30">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSod7CJvOSEFdtFtmH1pbaPYSW8M4gXMwsmWA&s" className="rounded-2xl w-40 h-30 ml-3 mt-3" />
            <h1 className="text-center text-3xl mt-5">JS</h1>
          </div>
          <div className="bg-[#f5f5f5] h-50 w-50 flex flex-col  rounded-2xl shadow-xl ml-30">
            <img src="https://raw.githubusercontent.com/github/explore/80688e429a7d4ef2fca1e82350fe8e3517d3494d/topics/sql/sql.png" className="rounded-2xl w-40 h-30 ml-3 mt-3" />
            <h1 className="text-center text-3xl mt-5">SQL</h1>
          </div>
         </div>
      ...
      <div id="Projects">
       ...
       <div className=" h-100 w-250 rounded-2xl shadow-xl ml-50 mb-10">
       <div className="flex flex-row align-center">
        <img src="https://t4.ftcdn.net/jpg/04/68/46/01/360_F_468460110_n5PvzMMql9h9ZxQy1fIrlJwJdJlOsuza.jpg" className=" w-150 h-100 mb-40 rounded-4xl" />
        <div className="flex flex-col">
        <p className="text-4xl ml-3">To see the website click on the</p>
        <a href=" https://alifoodcourt.ccbp.tech/ " className="text-4xl text-white ml-5"><span>web site</span></a>
        </div>
        
       </div>
       </div>
       <div className="flex flex-row align-center">
         <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQczvYhOXcYsaDMxbAztNZN_1cmNcEy-vYBEg&s" className="ml-50 w-150 h-100 rounded-4xl mb-4" />
        <a href="https://aliguessinggame.ccbp.tech/" className="text-4xl text-white ml-5">LINK</a>
       </div>
      </div>
      <div id="Contacts">
         ...
         <div className="flex flex-col  ml-100 ">
          ...
          <button className="bg-sky-500 w-100 h-7 mt-5">Submit</button>
